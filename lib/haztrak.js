...
var cliOptions = function optionMatcher (args /*: Array<string> */) {
...
var _spec = "axios";
var _where = "/home/dg/Projects/Rint";
var author = {
	name: "Matt Zabriskie"
};
var browser = {
...
async function eManLink (linkObj) {
  try {
    ...
    if (linkObj.page.length > 5) {
      ...
      const siteId = linkObj.epaSiteId.toUpperCase();
      const mtn = linkObj.mtn.map((x) => { return x.toUpperCase()});
      ...
      const page = linkObj.page.charAt(0).toUpperCase() + linkObj.page.slice(1).toLowerCase();
      const mtn = linkObj.mtn.toUpperCase();
      const siteId = linkObj.epaSiteId.toUpperCase();
      const res = await axiosPost({
        url: '/links/emanifest',
        data: {
...
async function eManCorrect (mtnJson, zipPath) {
  try {
    if (zipPath) {
      ...
      form.append('attachment', fs$2.createReadStream(zipPath));
...
var eManServices = /*#__PURE__*/Object.freeze({
  ...
  bill: eManBill,
  search: eManSearch,
  correctionDetail: eManCorrectionDetails,
  correction: eManCorrection,
  siteMtn: siteMtn,
  get: eManGet,
  sites: eManSites,
  correct: eManCorrect,
...
export { eManServices as eMan, eManLink, eManLookup, lookup, siteDetails, siteExist };
